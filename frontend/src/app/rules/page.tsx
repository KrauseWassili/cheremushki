    ...
    <main className="mx-auto w-full max-w-6xl px-4 py-4 sm:px-6 sm:py-6">
      ...
      <section className="section-block">
        ...
        <p className="section-block__text">
          ...
          возможности делитесь собственным опытом и помогайте другим.
        </p>

        <p className="section-block__text">
          Рассказывать о своей работе, проектах и услугах можно открыто и по
          делу. Если у вас есть личная или коммерческая заинтересованность в
      ...
      <section className="section-block">
        ...
        <p className="section-block__text">
          ...
          вне клуба, сначала спросите его согласие.
        </p>
      ...
      <section className="section-block">
        ...
        <p className="section-block__text">
          Для вступления необходимо пройти процедуру регистрации, а затем заполнить анкету, предоставив достоверную
          информацию о себе.
        </p>

        <p className="section-block__text">
          После регистрации участник получает доступ на страницу клуба и персональную ссылку на закрытую
          Telegram-группу. Данную ссылку нельзя публиковать или передавать другим
          людям.
        </p>
      </section>
